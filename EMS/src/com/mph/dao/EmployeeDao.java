...
public class EmployeeDao {
	...
	public void type_scroll_insensitive_rs()
	{
		con = MyDBConnection.getDBConnection();
		try {
			ps = con.prepareStatement("select ename,eid from mphemp",ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
			rs = ps.executeQuery();
	...
	public void batchUpdate()
	{
		...
		{
			st= con.createStatement();
			st.addBatch("update mphemp set ename = 'Bharadwaj' where eid=100");
